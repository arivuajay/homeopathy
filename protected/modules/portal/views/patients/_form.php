...
<?php //echo $form->errorSummary($model); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <span id="span_username"><?php echo $user_model->ur_username ?>&nbsp;</span>( <?php echo CHtml::link(Myclass::t('APP65'), '#edit_username', array('data-toggle' => "modal")) ?> )
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
                    <?php echo $form->textField($model,'pt_dob',array('class'=>'form-control default-date-picker')); ?>
