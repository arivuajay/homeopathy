...
insert  into `hme_med_categories`(`med_cat_id`,`med_cat_name`,`med_cat_parent`,`med_cat_unit`,`med_cat_desc`,`med_cat_status`) values (4,'Main Category 1',NULL,'1','This is a main category','1'),(5,'Sub category for main cat 1',4,'1','Sub category for main cat 1','1'),(6,'Sub category for main cat 1',4,'1','test','1');
...
insert  into `hme_med_stock`(`tenant`,`stk_id`,`stk_med_id`,`stk_pkg_id`,`stk_batch_no`,`stk_avail_units`,`stk_debit_units`,`check_row`) values (1,12,6,15,'New med - Unit 2',10,0,''),(1,13,6,14,'New med - Unit 1',0,0,NULL);
...
insert  into `hme_medicine_pkg`(`pkg_id`,`pkg_med_id`,`pkg_med_unit`,`pkg_med_power`) values (14,6,'Unit 1','Potency 1'),(15,6,'Unit 2','Potency 2');
...
insert  into `hme_medicines`(`tenant`,`med_id`,`med_cat_id`,`med_name`,`med_desc`,`med_status`) values (1,6,4,'New Medicine','New Medicine','1');
...
insert  into `hme_purchase_order`(`tenant`,`po_id`,`po_date`,`po_vendor`,`po_invoice`,`po_memo`,`po_total`,`po_paid`,`po_status`,`po_created_by`) values (1,30,'2014-12-25 00:00:00',1,'555','test','1000.00','1000.00','1',1);
...
insert  into `hme_purchase_order_medicines`(`itm_id`,`itm_po_id`,`itm_med_id`,`itm_pkg_id`,`itm_batch_no`,`itm_manf_date`,`itm_exp_date`,`itm_vat_tax`,`itm_mrp_price`,`itm_discount`,`itm_net_rate`,`itm_qty`,`itm_total_price`) values (48,30,6,15,'New med - Unit 2','2014-12-19 00:00:00','2014-12-01 00:00:00','14.50','50.00','5.00','47.50',10,'475.00');
...
insert  into `hme_tenants`(`tn_id`,`tn_hospital_name`,`tn_address_one`,`tn_address_two`,`tn_address_three`,`tn_city`,`tn_state`,`tn_country`,`tn_website`,`tn_email`,`tn_created_at`,`tn_created_by`,`tn_status`) values (1,'Abraham Homeo Clinic','Sample Address','Sample Address','Sample Address',0,0,0,'Website','Email','2014-11-14 19:50:18',0,'1');
...
insert  into `hme_users`(`tenant`,`ur_id`,`ur_role_id`,`ur_username`,`ur_password`,`ur_activation_key`,`ur_created_at`,`ur_modified_at`,`ur_last_login`,`ur_last_ip`,`ur_status`) values (1,1,11,'hadmin','b3122934150f9c276fedf3ade4801c0944fe54ed1b52402f664ac2f2ad6a5b087e7157bbbc30357e6f184534139e941cf8184762965f689ebee8f6e3806a48bc',NULL,'2014-11-17 12:47:34','2014-12-01 13:04:39','2014-12-01 13:04:39','127.0.0.1','1'),(1,46,9,'stanleyyyyyy','stanley',NULL,'2014-11-19 11:09:47','2014-11-19 17:15:19','0000-00-00 00:00:00',NULL,'1'),(1,48,9,'test','test',NULL,'2014-11-19 17:16:37','2014-11-19 17:20:17','0000-00-00 00:00:00',NULL,'1'),(1,49,10,'nadesh','admin',NULL,'2014-11-25 16:40:41','2014-11-25 16:40:41','0000-00-00 00:00:00',NULL,'1'),(1,50,8,'prakash','admin',NULL,'2014-12-01 18:02:45','0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,'1');
...
insert  into `hme_vendors`(`tenant`,`ven_id`,`ven_name`,`ven_address`,`ven_phone_no`,`ven_email`,`ven_status`,`ven_created_by`,`ven_created_at`) values (1,1,'Prakash arul mani vendor','1 Ahimshapuram 5th street,\r\nSellur,\r\nMadurai','9566699580','prakash.paramanandam@arkinfotec.com','1',1,'2014-12-01 18:31:49');
...
/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `hme_purchase_order_medicines_delete` AFTER DELETE ON `hme_purchase_order_medicines` FOR EACH ROW BEGIN
	...
	UPDATE hme_med_stock
	SET stk_avail_units = v_old_avail_units - old.itm_qty
	WHERE stk_id = v_stk_id;
