...
MySQL - 5.6.17 : Database - homeopathy
*********************************************************************
*/
...
insert  into `hme_doctor_profile`(`docinfo_id`,`user_id`,`doc_firstname`,`doc_lastname`,`doc_dob`,`doc_speciality`,`doc_certificate`,`doc_designated`,`doc_awards`,`doc_about`,`doc_address_1`,`doc_address_2`,`doc_city`,`doc_state`,`doc_country`,`doc_phone`,`doc_mobile_no`) values (2,3,'test','test','2014-10-12','trest','test','','','','','',11,11,1,'','');
