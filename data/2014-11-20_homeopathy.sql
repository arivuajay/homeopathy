...
insert  into `hme_med_categories`(`med_cat_id`,`med_cat_name`,`med_cat_parent`,`med_cat_unit`,`med_cat_desc`,`med_cat_status`) values (1,'test cat',NULL,'1','test desc','1'),(2,'test cat',1,'2','testing','1');
