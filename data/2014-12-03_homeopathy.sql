...
insert  into `hme_med_stock`(`tenant`,`stk_id`,`stk_med_id`,`stk_pkg_id`,`stk_batch_no`,`stk_avail_units`,`stk_debit_units`) values (1,16,8,17,'TEST0001',50,0),(1,17,8,17,'TEST0002',100,0);
...
insert  into `hme_medicine_pkg`(`pkg_id`,`pkg_med_id`,`pkg_med_unit`,`pkg_med_power`) values (17,8,'m1-unit1','m1-pot1');
...
insert  into `hme_medicines`(`tenant`,`med_id`,`med_cat_id`,`med_name`,`med_desc`,`med_status`) values (1,8,8,'Medicine Name 1','Medicine Name 1','1');
...
insert  into `hme_purchase_order`(`tenant`,`po_id`,`po_date`,`po_vendor`,`po_invoice`,`po_memo`,`po_total`,`po_paid`,`po_status`,`po_created_by`) values (1,33,'2014-12-02 00:00:00',1,'00001','Memo one','1000.00','500.00','1',1);
...
insert  into `hme_purchase_order_medicines`(`itm_id`,`itm_po_id`,`itm_med_id`,`itm_pkg_id`,`itm_batch_no`,`itm_manf_date`,`itm_exp_date`,`itm_vat_tax`,`itm_mrp_price`,`itm_discount`,`itm_net_rate`,`itm_qty`,`itm_total_price`) values (51,33,8,17,'TEST0001','2014-08-08 00:00:00','2020-08-08 00:00:00','5.00','50.00','5.00','47.50',50,'2375.00'),(52,33,8,17,'TEST0002','2014-01-29 00:00:00','2020-08-12 00:00:00','5.00','20.00','30.00','14.00',100,'1400.00');
...
insert  into `hme_vendors`(`tenant`,`ven_id`,`ven_name`,`ven_address`,`ven_phone_no`,`ven_email`,`ven_status`,`ven_created_by`,`ven_created_at`) values (1,1,'Supplier 1','1 Ahimshapuram 5th street,\r\nSellur,\r\nMadurai','9566699580','prakash.paramanandam@arkinfotec.com','1',1,'2014-12-02 19:03:29');
