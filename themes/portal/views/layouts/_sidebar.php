    ...
    'items' => array(
        ...
        array('label' => '<i class="fa fa-users"></i><span>' . Myclass::t('APP219') . '</span>', 'url' => '#', 'itemOptions' => array("class" => "sub-menu"),
            'items' => array(
                ...
                array('label' => '<i class="fa fa-user-md"></i><span>' . Myclass::t('APP305') . '</span> ', 'url' => array('/portal/pharmacist/index')),
        ...
        array('label' => '<i class="fa fa-shopping-cart"></i><span>' . Myclass::t('APP94') . '</span>', 'url' => array('/portal/purchaseorder/index')),
        array('label' => '<i class="fa fa-bar-chart-o"></i><span>' . Myclass::t('APP230') . '</span>', 'url' => array('/portal/salesorder/index')),
        array('label' => '<i class="fa fa-file-text"></i><span>' . Myclass::t('APP226') . '</span>', 'url' => '#', 'itemOptions' => array("class" => "sub-menu"),
            'items' => array(
                array('label' => '<i class="fa fa-stack-exchange"></i><span>' . Myclass::t('APP243') . '</span>', 'url' => array('/portal/medstock/index')),
            ),
        ),
